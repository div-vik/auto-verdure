...
const CollectionCard = ({ title, description }) => {
  return (
    <div className="w-fit h-fit md:h-fit p-3 md:p-0 md:flex flex-row-reverse rounded-xl md:rounded-[32.1px] xl:rounded-[56px] md:overflow-hidden bg-[#F8F8F8] border-[2.86px] hover:border-[2.86px] hover:border-primaryMain">
      <Image
